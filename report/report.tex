...
\begin{document}
\begin{center}
{\Large \textbf{JonesAuto Database Management System}}\\[0.4cm]
CPSC 3660\\[0.3cm]
Gurmann Basran\\[0.3cm]
April 8, 2026
\end{center}
\vspace{0.5cm}
...
We went through normalization in class covering 1NF, 2NF, 3NF, and BCNF. All of my tables are in 3NF. There are no partial dependencies since every primary key is a single-column AUTO\_INCREMENT integer, which means 2NF is satisfied automatically. There are no transitive dependencies either: each non-key attribute depends directly on the primary key of its table, not on some other non-key column.
...
\begin{center}\includegraphics[width=0.85\textwidth]{imgs/purchase_form.png}\end{center}
...
\begin{center}\includegraphics[width=0.85\textwidth]{imgs/sale_form.png}\end{center}
...
\begin{center}\includegraphics[width=0.85\textwidth]{imgs/warranty_form.png}\end{center}
...
\begin{center}\includegraphics[width=0.85\textwidth]{imgs/payment_form.png}\end{center}
...
\begin{center}\includegraphics[width=0.85\textwidth]{imgs/customer_form.png}\end{center}
...
\begin{center}\includegraphics[width=0.85\textwidth]{imgs/employee_form.png}\end{center}
...
\begin{center}\includegraphics[width=0.95\textwidth]{imgs/inventory.png}\end{center}
...
\begin{center}\includegraphics[width=0.95\textwidth]{imgs/sales_report.png}\end{center}
...
\begin{center}\includegraphics[width=0.95\textwidth]{imgs/payment_history.png}\end{center}
...
\begin{center}\includegraphics[width=0.95\textwidth]{imgs/repair_summary.png}\end{center}
...
\begin{center}\includegraphics[width=0.95\textwidth]{imgs/warranty_report.png}\end{center}
...
\begin{center}\includegraphics[width=0.95\textwidth]{imgs/late_payments.png}\end{center}
...
\begin{enumerate}
  ...
  \item \textbf{AUTO\_INCREMENT surrogate keys everywhere}: Every table uses an INT AUTO\_INCREMENT primary key instead of composite or natural keys. It is simpler for foreign key references and avoids issues if natural values change. I went with surrogate keys because they are straightforward.
...
The biggest thing I took away from this project is how normalization actually works in practice. In class we walked through functional dependencies and decomposition on paper, but actually deciding where to denormalize for a real application was a different kind of challenge. It is one thing to identify a transitive dependency; it is another to decide whether the performance trade-off is worth it.
...
Drawing the E-R diagram first and then mapping it to relational tables made the schema design way more structured than if I had just started creating tables. It forced me to think about relationships and cardinalities before writing any SQL.
...
\begin{enumerate}
  \item \textbf{User login system}: Right now anyone can access everything. A real system would need separate logins for buyers, salespeople, and managers, with different permissions for each. 
